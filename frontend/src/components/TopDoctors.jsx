...
const TopDoctors = () => {
  ...
  //getting doctors data from context
  const { doctors } = useContext(AppContext);

  return (
    <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
      <h1 className="text-3xl font-bold tracking-tight text-gray-900">Featured Specialists</h1>
      <p className="sm:w-1/2 text-center text-sm text-gray-500 leading-relaxed">
        Consult with top-rated medical experts hand-picked for their outstanding track record of patient satisfaction.
      </p>
